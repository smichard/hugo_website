...
{{< figure src="/images/posts/post_01/mapping.png" title="Mapping a custom domain to the Google Cloud Run service" >}}
...
{{< figure src="/images/posts/post_01/trigger.png" title="Creating a trigger to automatically deploy the website on each git commit" >}}
...
## Summary
{{< figure src="/images/posts/post_01/summary.png" title="Presentation of the complete workflow" >}}
